...
$(document).ready(function(){
	...
	//传入后台的数字为确定的时间在数组里的序列，直接用即可，第一个是0
	$("form").append("<input type='hidden' value='"+$(":radio:checked").val()+"'>");
})
function draw(a,b,c,no){
	if(a==0)
		...
		if(no)
			...
			$(".time_calendar").append("<div class='calendar_mine'><input type='checkbox' name='decide'></div>");
		}
	}
